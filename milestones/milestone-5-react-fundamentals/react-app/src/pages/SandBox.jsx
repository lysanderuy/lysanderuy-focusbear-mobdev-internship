  ...
  return (
    <>
      <style>{`
        ...
        .fade-4 { animation: fadeUp 0.7s ease 0.3s both; }
        .fade-5 { animation: fadeUp 0.7s ease 0.4s both; }
        .fade-6 { animation: fadeUp 0.7s ease 0.5s both; }
        .fade-7 { animation: fadeUp 0.5s ease 0.6s both; }
      ...
      >
        ...
        {/* MAIN */}
        <main className="relative z-10 flex-1 flex flex-col items-center justify-start px-14 py-10 gap-6">
          <h1
          ...
          <p
            className={`text-[#c2d878] text-xs max-w-md text-center ${
              mounted ? "fade-3" : "opacity-0"
            }`}
          >
            Place your components here to test it.
          </p>
